...
export const DATABASE_TO_PROP = {
  ...
  filesEnforcedExpirationEnabled: 'files.enforcedExpirationEnabled',
  filesEnforcedExpiration: 'files.enforcedExpiration',
  filesEnforcedExpirationBypassAdmins: 'files.enforcedExpirationBypassAdmins',
  filesEnforcedExpirationBypassUsers: 'files.enforcedExpirationBypassUsers',
