...
export const schema = z.object({
  ...
  files: z.object({
    ...
    enforcedExpirationEnabled: z.boolean().default(false),
    enforcedExpiration: z.string().nullable().default(null),
    enforcedExpirationBypassAdmins: z.boolean().default(false),
    enforcedExpirationBypassUsers: z.array(z.string()).default([]),
