      ...
      <form onSubmit={form.onSubmit(onSubmit)}>
        ...
        <SimpleGrid mt='md' cols={{ base: 1, md: 2 }} spacing='lg'>
          <Paper withBorder p='sm'>
            ...
            <TextInput label='Discord Client ID' disabled={
              data?.locked['oauthDiscordClientId']
            } {...form.getInputProps('oauthDiscordClientId')} />
            <TextInput label='Discord Client Secret' disabled={
          ...
          <Paper withBorder p='sm'>
            ...
            <TextInput label='Google Client ID' disabled={
              data?.locked['oauthGoogleClientId']
            } {...form.getInputProps('oauthGoogleClientId')} />
            <TextInput label='Google Client Secret' disabled={
        ...
        <Paper withBorder p='sm' my='md'>
          ...
          <SimpleGrid mt='md' cols={{ base: 1, md: 2 }} spacing='lg'>
            <TextInput label='GitHub Client ID' disabled={
              data?.locked['oauthGithubClientId']
            } {...form.getInputProps('oauthGithubClientId')} />
            <TextInput label='GitHub Client Secret' disabled={
